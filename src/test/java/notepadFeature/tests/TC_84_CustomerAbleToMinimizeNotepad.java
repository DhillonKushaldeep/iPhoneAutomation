 ...
 *
 * Customer should have the ability to Minimize the Notepad after receiving a message. And then see the additional message.
 * 
 */
public class TC_84_CustomerAbleToMinimizeNotepad extends BaseTest{

	@Test
	public void CustomerAbleToMinimizeNotepad() throws InterruptedException {
