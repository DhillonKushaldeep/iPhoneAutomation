 ...
 * 
 * The larger message should be displayed in the Notepad and the Customer should be able to view the message by scrolling down.
 */
public class TC_80_CustomerViewLargerMessage_UsingScrollButtons extends BaseTest{

	@Test
	public void CustomerViewLargerMessage_UsingScrollButtons() throws InterruptedException {
	 ...
	 */
		...
		System.out.println("\"This is a TEST sending message from LINC INTERPRETER to the customer\" is displayed in TEXTBOX"); //This message is SENT from LINC INTERPRETER.
		notepad.click_ScrollDown();
		notepad.click_ScrollUP();
