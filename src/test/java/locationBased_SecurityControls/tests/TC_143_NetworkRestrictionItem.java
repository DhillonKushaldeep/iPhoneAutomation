 ...
 * 
 * 1.The call should not be established successfully. 
 * 2.The below given message should be displayed    "Your organization allows access to InSight Interpreters from specific locations. Based on your device location, 
 *                                                   you are outside the approved area for access. Please contact your administrator for more information"
 *
 */
public class TC_143_NetworkRestrictionItem extends BaseTest{  //Kushauth02

	@Test
	public void NetworkRestrictionItem() throws InterruptedException {
