 ...
 *
 */
public class TC_112_AllLang_TopLang_Search_Displayed extends BaseTest{

	@Test
	public void AllLang_TopLang_Search_Displayed() throws InterruptedException {
		...
		Thread.sleep(2000);
		languageScreen.verify_searchLanguagesDisplayed();
