 ...
 * 
 * The following - options should be displayed in the Video screen:
    1. Audio Mute ON / OFF
    2. Video Mute ON / OFF
    3. End Call button 
 *
 */
public class TC_57_ValidateDisplayOptions extends BaseTest{

	@Test
	public void ValidateDisplayOptions() throws InterruptedException {
