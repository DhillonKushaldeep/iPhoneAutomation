 ...
 *
 */
public class TC_134_SurveyWindowNotDisplayed extends BaseTest{

	@Test
	public void SurveyWindowNotDisplayed() throws InterruptedException {
	 ...
	 * After few seconds, the call will be ended to check if the Call Ended is DISPLAYED
	 * The audio call should end and the call ended icon should be displayed.
	 */
		
		
		CallSurveyWindow callSurveyWindow = new CallSurveyWindow(driver);
		callSurveyWindow.verifyCallEndedIconDisplayed();                                          //CALL ENDED  is Displayed
