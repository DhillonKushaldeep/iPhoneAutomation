 ...
 *
 */
public class TC_133_SurveyWindowDisplayed extends BaseTest{

	@Test
	public void SurveyWindowDisplayed() throws InterruptedException {
	...
	/**
	 * The AUDIO call to PUNJABI INTERPRETER is initiated.
	 ...
	 */
		...
		callSurveyWindow.verifyCallEndedIconDisplayed();                                          //The survey window should be displayed along with the CALL ENDED message.
		System.out.println("Call Ended is displayed on Survey window");
		
		callSurveyWindow.verifyHowDidWeDo_Displayed();                                            //The message "How did we do?" should be displayed
		System.out.println("The message \"How did we do?\" is displayed on Survey window");
		
		callSurveyWindow.click_CallEnded_StarOne();                                               //When user selects any star for rating, the text field to enter feedback should be displayed to the user 
		System.out.println("STAR ONE is clicked on Survey window");
		callSurveyWindow.click_TextBox("TEST");
		System.out.println("TEST is being typed on Survey window");
		callSurveyWindow.click_Done();
