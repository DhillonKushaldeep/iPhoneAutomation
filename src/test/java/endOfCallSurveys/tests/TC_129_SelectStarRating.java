 ...
 *
 */
public class TC_129_SelectStarRating extends BaseTest{

	@Test
	public void SelectStarRating() throws InterruptedException {
	 ...
	 */
		...
		callSurveyWindow.click_CallEnded_StarOne();                                        //Select any star icon in survey window for rating and click on done. 
