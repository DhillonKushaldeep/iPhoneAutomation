 ...
 *
 */
public class TC_131_EnterTextFeedBack extends BaseTest{

	@Test
	public void EnterTextFeedBack() throws InterruptedException {
	 ...
	 */
		...
		callSurveyWindow.click_CallEnded_StarOne();                                
		System.out.println("STAR ONE is clicked on Survey window");
		
		System.out.println(driver.findElementByAccessibilityId("callEndedComment").getText());
		
		
		
        MobileElement element = (MobileElement) driver.findElementByAccessibilityId("callEndedComment");
		
		String message = element.getText();
		String SucessMessage = "Please enter your feedback here";	                   
						 
	    assertEquals(message, SucessMessage);					//Added ASSERTION to compare the text.
		Thread.sleep(5000);	
