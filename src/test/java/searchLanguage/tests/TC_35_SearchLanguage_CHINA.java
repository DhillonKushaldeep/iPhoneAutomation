...
public class TC_35_SearchLanguage_CHINA extends BaseTest {
	...
	public void SearchLanguage_CHINA() throws InterruptedException {
	    ...
	    Thread.sleep(2000);
	    languageScreen.verify_LanguageDisplayed_BySeaching_forChina();    //verify that Chinese languages(Cantonese, Chaochow) are displayed in dropdown when we enter CHINA in search box    
	    Thread.sleep(2000);
